...
public class CurrencyActivity extends AppCompatActivity {
    ...
    String url = "http://138.197.165.209:5000/convert/";

    RequestQueue requestQueue;

    CardView changeCurrency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            if (!(Prefs.getPrefs("country_from", CurrencyActivity.this).equals("notfound"))) {
                countryFrom.setText(Prefs.getPrefs("country_from", CurrencyActivity.this));
            } else {
                countryFrom.setText("USD");
            }

            if (!(Prefs.getPrefs("country_to", CurrencyActivity.this).equals("notfound"))) {
                countryTo.setText(Prefs.getPrefs("country_to", CurrencyActivity.this));
            } else {
        ...
        currencyApi(CurrencyActivity.this);

        Globals.getCountryCode(CurrencyActivity.this);
        ...
        mAdapter = new CurrencyAdapter(CurrencyActivity.this, Globals.NEWcountryCode, Globals.NEWcountriesCurrencies);
        ...
        linearLayoutOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InputMethodManager imm = (InputMethodManager) CurrencyActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
...
//                behavior.setPeekHeight(screenHeight/2);
        ...
        interchange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                url = "http://138.197.165.209:5000/convert/";
                String currencyFrom = String.valueOf(countryFrom.getText());
...
//        relativeOne.setOnTouchListener(new RelativeLayoutTouchListener(this));
    ...
    private void initialize() {
        ...
        tfRegular = Typeface.createFromAsset(getApplicationContext().getAssets(), "fonts/OpenSans-Light.ttf");
        ...
        final JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            currency_to.setText(response.getString("result"));
